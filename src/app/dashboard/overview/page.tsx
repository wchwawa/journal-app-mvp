...
export default function OverviewPage() {
  return (
    <div className='from-background via-background to-muted/10 flex w-full flex-1 bg-gradient-to-br'>
      <div className='mx-auto flex w-full max-w-md flex-1 flex-col gap-4 px-5 pt-2 pb-0 sm:max-w-lg sm:px-6'>
        {/* Top widgets section */}
        <motion.div
        ...
        >
          ...
          <div className='border-border/30 bg-card/90 hover:border-border/40 relative h-full rounded-[1.75rem] border p-6 shadow-xl backdrop-blur-md transition-all duration-300 hover:shadow-2xl'>
            <AudioJournalPanel />
          </div>
        </motion.div>
      </div>
